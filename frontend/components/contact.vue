...
<template>
  <TezLazy class="tezLazy" :sourcePath="data.dynamicSourcePath" v-slot="source">
    <div class="mt-24">
      ...
      <section
        class="bg-white py-42 lg:py-[120px] overflow-hidden relative z-10 contact-page "
      >
        <div class="container">
          <tez-iterator class="" :items="source.items" v-slot="contact">
              ...
              <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
                <div class="max-w-[570px] mb-12 lg:mb-0">
                  ...
                  <div class="flex mb-8 max-w-[370px] w-full">
                    ...
                    <div class="w-full">
                      <h4 class="font-bold text-dark text-xl mb-1">Address</h4>
